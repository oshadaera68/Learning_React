...
const Customer: React.FC = () => {
  ...
  const updateCustomer = async () => {
    try {
      await axios.put(
        "http://localhost:3000/api/v1/customers/update/" + selectedCustomerId,
        {
          name: updateName,
  ...
  const findAllCustomers = async () => {
    const response = await axios.get(
      "http://localhost:3000/api/v1/customers/find-all?searchText=&page=1&size=10"
    );
  ...
  const deleteCustomer = async (id: string) => {
    await axios.delete(
      "http://localhost:3000/api/v1/customers/delete-by-id/" + id
    );
  };

  const loadModal = async (id: string) => {
    const customer = await axios.get(
      "http://localhost:3000/api/v1/customers/find-by-id/" + id
    );
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12">
            <button onClick={saveCustomer} className="btn btn-primary col-12">
              Save Customer
            </button>
          </div>
        </div>
      ...
      <Modal show={modalState}>
        <div className="p-4">
          ...
          <div className="col-12">
            ...
            <button
              type="button"
              className="btn-secondary btn col-12"
