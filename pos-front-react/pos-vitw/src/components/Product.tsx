...
const Product: React.FC = () => {
  ...
  const findAllProducts = async () => {
    const response = await axios.get(
      "http://localhost:3000/api/v1/products/find-all?searchText=&page=1&size=10"
    );
  ...
  const deleteProduct = async (id: string) => {
    await axios.delete(
      "http://localhost:3000/api/v1/products/delete-by-id/" + id
    );
    findAllProducts();
  };
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12">
            <button className="btn btn-primary col-12" onClick={saveProduct}>
              Save Product
            </button>
          </div>
        </div>
